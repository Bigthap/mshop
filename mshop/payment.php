...
<?php if (!$isConfirm): ?>
  ...
  <div class="page">
    ...
    <div class="card">
      ...
      <div class="cap">* เดโม: ยังไม่คิดค่าส่ง/ภาษี</div>
    </div>
    ...
    <div class="card">
      ...
      <form method="post" action="payment.php" autocomplete="off" novalidate>
        ...
        <div class="line"></div>
        <div class="cap">เดโมเท่านั้น: ปุ่ม “ชำระเงิน” จะจำลองการชำระเงินสำเร็จ</div>
...
<?php else: ?>
  ...
  <div class="card" style="width:min(680px,100%)">
    ...
    <p><span class="success">การชำระเงินของคุณได้รับการยืนยัน (เดโม)</span></p>
    ...
    <div class="btnrow">
      ...
      <a class="btn ghost" href="../mshop/logout.php">ออกจากระบบ</a>
    </div>

    <p class="cap" style="margin-top:10px">* หน้านี้เป็นตัวอย่าง Mockup เท่านั้น ยังไม่บันทึกคำสั่งซื้อจริงลงฐานข้อมูล</p>
  </div>
<?php endif; ?>
</body>
</html>
