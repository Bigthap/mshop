...
<body>
  <div class="container" style="padding-top:24px">
    <nav>
      <div class="nav-wrap">
        ...
        <div class="nav-links">
            ...
            <a href="/mshop/login.php">Logout</a>
        </div>
      </div>
    </nav>
            ...
            ?>
              <article class="card" role="listitem">
                <img class="thumb" src="<?php echo $img; ?>" alt="<?php echo $name; ?>"
                     onerror="this.onerror=null;this.src='https://media.discordapp.net/attachments/899025026026704967/1431146364150222978/nope-not-here.png?ex=68fc5a6a&is=68fb08ea&hm=7966820f0b457c9e696ae5941a0cae41d972fea9beff04683fae73a6dda0dad2&=&format=webp&quality=lossless';">
                ...
                <div class="rowbtn">
                  ...
                  <a class="btn ghost" href="../products/buy.php?id=<?php echo (int)$id; ?>" target="_blank">ดูหน้า Product</a>
                </div>
              </article>
            <?php endforeach; ?>
          </div>
    ...
    <footer>
      Copyright © <?php echo date('Y'); ?> — Admin-AuanCheng — All rights reserved
    </footer>
  </div>
