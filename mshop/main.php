  ...
  <div class="container" style="padding-top:24px">
    <nav>
      <div class="nav-wrap">
        ...
        <div class="nav-links">
          <a href="Support.php">ติดต่อ</a><a href="Credit.php">เครดิต</a><a href="/mshop/logout.php">Logout</a>
        </div>
      </div>
    </nav>
    ...
    <footer>
      <div style="text-align:center;">Copyright © 2025 Teeramate AuanCheng — All rights reserved</div>
    </footer>
  </div>
</body>
</html>
